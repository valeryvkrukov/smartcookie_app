            ...
            <div x-data="{ confirmDelete: false }">
                <button type="button"
                    @click="isRecurring
                        ...
                        : $dispatch('confirm-delete', { name: subject + ' with ' + ($el.closest('form').querySelector('[name=student_id]').selectedOptions[0]?.text || 'student'), formId: 'delete-session-form', isRecurring: false, useAjax: true })"
