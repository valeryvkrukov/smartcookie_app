    ...
    <form 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
                        ...
                        @forelse($user->subjectRates as $sr)
                            <div class="flex items-center justify-between p-6 bg-slate-50 rounded-3xl border border-slate-100 group hover:bg-white hover:shadow-xl hover:shadow-slate-100 transition-all duration-500">
                                ...
                                <div class="flex items-center space-x-6">
                                    ...
                                    <button type="button" 
                                            @click="$dispatch('confirm-delete', { name: '{{ $sr->subject }} rate', formId: 'delete-rate-{{ $sr->id }}' })"
            ...
            <div class="space-y-8">
                ...
                <!-- Кнопка удаления (Modern Style) -->
                <button type="button" 
                        @click="$dispatch('confirm-delete', { name: '{{ $user->full_name }}', formId: 'delete-user-{{ $user->id }}' })"
